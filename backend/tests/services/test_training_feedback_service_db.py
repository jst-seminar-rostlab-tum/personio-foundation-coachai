...
class TestTrainingFeedbackService(unittest.TestCase):
    ...
    def test_generate_and_store_feedback(
        ...
        self.assertEqual(
            feedback.example_positive[0]["heading"], 'Clear Objective Addressed')
        self.assertEqual(
        ...
        self.assertEqual(feedback.example_negative[0]["quote"],
                         "That's not important right now.")
        self.assertEqual(feedback.example_negative[0]["improved_quote"],
        ...
        self.assertEqual(feedback.recommendations[0]["text"],
                         'When giving feedback, use the Situation, Task, Action, '
                         'Result framework to provide more concrete examples.')
        self.assertEqual(feedback.recommendations[1]["heading"],
                         'Ask more diagnostic questions')
        self.assertEqual(feedback.recommendations[1]["text"],
