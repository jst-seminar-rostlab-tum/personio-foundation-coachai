...
class ConversationTurn(CamelModel, table=True):  # `table=True` makes it a database table
...
class ConversationTurnCreate(CamelModel):
    session_id: UUID
    speaker: SpeakerEnum
    start_offset_ms: int
    end_offset_ms: int
...
class ConversationTurnRead(CamelModel):
    id: UUID
    session_id: UUID
    speaker: SpeakerEnum
    start_offset_ms: int
