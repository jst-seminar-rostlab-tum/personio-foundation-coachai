    ...
    <div className="min-h-screen min-w-screen flex items-center justify-center py-4 px-4">
      <div className="w-full max-w-md text-center">
        <div className="flex flex-col items-center gap-6">
          <div className="w-16 h-16 bg-bw-40 rounded-full flex items-center justify-center">
            <TriangleAlert className="w-8 h-8 text-bw-70" />
          </div>
          ...
          <p className="text-bw-70 text-sm leading-relaxed max-w-sm">{t('description')}</p>
