  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      ...
      <div className="flex-1 flex flex-col items-center justify-between px-4 py-2">
        {/* Title skeleton */}
        <div className="w-3/4 h-8 mt-4 mb-2 text-2xl font-bold text-gray-400 text-center">Personalize Your Experience</div>
        {/* Subtitle skeleton */}
      ...
      <div className="flex justify-center pb-2">
        <Link href="/dashboard" className="text-sm text-gray-500 hover:underline">Skip for now</Link>
      </div>
    </div>
  );
} 