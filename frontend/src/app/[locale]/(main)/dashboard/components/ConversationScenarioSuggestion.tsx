    ...
    <section className="flex flex-col items-center justify-center w-full">
      <div className="flex flex-col md:flex-row md:items-center gap-6 mb-4 justify-center w-full max-w-2xl">
        ...
        >
          ...
          <span className="hidden md:block absolute right-[-20px] top-1/2 -translate-y-1/2 w-0 h-0 border-y-[20px] border-y-transparent border-l-[20px] border-l-bw-50"></span>
          <span className="block md:hidden absolute left-1/2 bottom-[-20px] -translate-x-1/2 w-0 h-0 border-x-[20px] border-x-transparent border-t-[20px] border-t-bw-50"></span>
        </div>
        <Image
