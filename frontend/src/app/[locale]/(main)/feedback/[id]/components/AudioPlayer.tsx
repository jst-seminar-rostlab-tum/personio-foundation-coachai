...
export default function AudioPlayer({
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="w-full border border-bw-40 rounded-lg p-6 flex flex-col items-center">
        {fullAudioUrl ? (
          <>
            ...
            <div className="flex items-center justify-center gap-8 w-full">
              <button
                type="button"
                className="w-12 h-12 rounded-full flex items-center justify-center cursor-pointer transition-colors duration-300 hover:bg-bw-40"
