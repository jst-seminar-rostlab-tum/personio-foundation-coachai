  ...
  return (
    <div data-slot="command-input-wrapper" className="flex h-9 items-center gap-2 border-b px-3">
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          'placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-custom-beige py-3 text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...props}
      />
