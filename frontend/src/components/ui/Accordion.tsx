  ...
  return (
    <AccordionPrimitive.Header className="flex text-bw-90 cursor-pointer">
      <AccordionPrimitive.Trigger
        ...
        className="px-2 text-xl focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center justify-between gap-4 rounded-md py-4 text-left transition-all outline-none focus-visible:ring-[3px] hover:bg-custom-beige disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180 cursor-pointer"
        {...props}
      >
        {children}
